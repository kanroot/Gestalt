...
namespace Laugh.BaseClass
{
	...
	{ 
		//texto interior
		[Child] protected AnimatedSprite TextAnimated { get;}
		...
		//shoots
		[Node("Node2D/Position2D")] protected Position2D PositionShoot { get; private set;}
		...
		//posicion de disparo
		[Child] protected Node2D Node2D { get; private set; } 
